...
export const metadata: Metadata = {
  title: "Nyam Dnyam - Fine Dining Restaurant",
  description: "Experience culinary excellence at Nyam Dnyam. Award-winning chef-driven cuisine with the finest ingredients. Reserve your table today.",
  keywords: "fine dining, restaurant, cuisine, reservation, culinary",
  metadataBase: new URL("https://nyamdnyam.com"),
  alternates: {
    canonical: "https://nyamdnyam.com"
  },
  openGraph: {
    title: "Nyam Dnyam - Fine Dining Restaurant",
    description: "Experience culinary excellence at Nyam Dnyam. Award-winning cuisine and exceptional service.",
    type: "website",
    siteName: "Nyam Dnyam",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766140578361-gg270zk8.jpg",
      alt: "Nyam Dnyam Restaurant"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Nyam Dnyam - Fine Dining Restaurant",
    description: "Experience culinary excellence. Reserve your table now.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1766140578361-gg270zk8.jpg"]
  }
};
